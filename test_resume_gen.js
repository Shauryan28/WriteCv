...
const sampleData = {
    personal: {
        ...
        summary: 'Experienced Software Engineer with a passion for building scalable web applications. Proven track record of optimizing performance and leading teams to success.' // >30 chars
    },
    experience: [
        {
...
try {
    ...
    generateResumePDF(sampleData, pdfStream);
